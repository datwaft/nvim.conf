...
(set vim.g.bubbly_colors {:total_buffer_number "red"})

(set vim.g.bubbly_styles {:total_buffer_number "bold"})

(set vim.g.bubbly_statusline
     [:mode
      :truncate
