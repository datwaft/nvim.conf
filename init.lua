local package_path_str = table.concat({
  "~/.cache/nvim/packer_hererocks/2.1.0-beta3/share/lua/5.1/?.lua",
  "~/.cache/nvim/packer_hererocks/2.1.0-beta3/share/lua/5.1/?/init.lua",
  "~/.cache/nvim/packer_hererocks/2.1.0-beta3/lib/luarocks/rocks-5.1/?.lua",
...
local install_cpath_pattern =
  "~/.cache/nvim/packer_hererocks/2.1.0-beta3/lib/lua/5.1/?.so"
